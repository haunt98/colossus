...
type ProcessRequest struct {
	...
	RequestDate int64  `protobuf:"varint,3,opt,name=request_date,json=requestDate,proto3" json:"request_date,omitempty"`
...
func (x *ProcessRequest) GetClientId() int32 {
	if x != nil {
		return x.ClientId
	}
	return 0
...
func (x *ProcessRequest) GetRequestDate() int64 {
	if x != nil {
...
func (x *ProcessRequest) GetSig() string {
	if x != nil {
		return x.Sig
	}
	return ""
...
func (x *GetStatusRequest) GetClientId() int32 {
	if x != nil {
		return x.ClientId
	}
	return 0
...
func (x *GetStatusRequest) GetRequestDate() int64 {
	if x != nil {
		return x.RequestDate
	}
	return 0
...
func (x *GetStatusRequest) GetSig() string {
	if x != nil {
		return x.Sig
	}
	return ""
...
func (x *GetStatusResponse) GetData() string {
	if x != nil {
		return x.Data
	}
	return ""
...
var file_gateway_proto_rawDesc = []byte{
	...
	0x0e, 0x61, 0x70, 0x69, 0x2e, 0x67, 0x61, 0x74, 0x65, 0x77, 0x61, 0x79, 0x2e, 0x76, 0x31, 0x22,
	0x0d, 0x0a, 0x0b, 0x50, 0x69, 0x6e, 0x67, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x22, 0x0e,
	0x0a, 0x0c, 0x50, 0x69, 0x6e, 0x67, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x76,
	...
	0x61, 0x12, 0x21, 0x0a, 0x0c, 0x72, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x5f, 0x64, 0x61, 0x74,
	0x65, 0x18, 0x03, 0x20, 0x01, 0x28, 0x03, 0x52, 0x0b, 0x72, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74,
	0x44, 0x61, 0x74, 0x65, 0x12, 0x10, 0x0a, 0x03, 0x73, 0x69, 0x67, 0x18, 0x04, 0x20, 0x01, 0x28,
	0x09, 0x52, 0x03, 0x73, 0x69, 0x67, 0x22, 0x74, 0x0a, 0x0f, 0x50, 0x72, 0x6f, 0x63, 0x65, 0x73,
	...
	0x01, 0x28, 0x09, 0x52, 0x07, 0x74, 0x72, 0x61, 0x6e, 0x73, 0x49, 0x64, 0x22, 0x7f, 0x0a, 0x10,
	...
	0x07, 0x74, 0x72, 0x61, 0x6e, 0x73, 0x49, 0x64, 0x12, 0x21, 0x0a, 0x0c, 0x72, 0x65, 0x71, 0x75,
	0x65, 0x73, 0x74, 0x5f, 0x64, 0x61, 0x74, 0x65, 0x18, 0x03, 0x20, 0x01, 0x28, 0x03, 0x52, 0x0b,
	0x72, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x44, 0x61, 0x74, 0x65, 0x12, 0x10, 0x0a, 0x03, 0x73,
	0x69, 0x67, 0x18, 0x04, 0x20, 0x01, 0x28, 0x09, 0x52, 0x03, 0x73, 0x69, 0x67, 0x22, 0x6f, 0x0a,
	...
	0x75, 0x72, 0x6e, 0x4d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x12, 0x12, 0x0a, 0x04, 0x64, 0x61,
	0x74, 0x61, 0x18, 0x03, 0x20, 0x01, 0x28, 0x09, 0x52, 0x04, 0x64, 0x61, 0x74, 0x61, 0x32, 0xf1,
	...
	,
	...
	0x21, 0x2e, 0x61, 0x70, 0x69, 0x2e, 0x67, 0x61, 0x74, 0x65, 0x77, 0x61, 0x79, 0x2e, 0x76, 0x31,
	0x2e, 0x47, 0x65, 0x74, 0x53, 0x74, 0x61, 0x74, 0x75, 0x73, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e,
	0x73, 0x65, 0x42, 0x0d, 0x5a, 0x0b, 0x2e, 0x3b, 0x67, 0x61, 0x74, 0x65, 0x77, 0x61, 0x79, 0x76,
...
var file_gateway_proto_goTypes = []interface{}{
	(*PingRequest)(nil),       // 0: api.gateway.v1.PingRequest
	(*PingResponse)(nil),      // 1: api.gateway.v1.PingResponse
	(*ProcessRequest)(nil),    // 2: api.gateway.v1.ProcessRequest
	(*ProcessResponse)(nil),   // 3: api.gateway.v1.ProcessResponse
	(*GetStatusRequest)(nil),  // 4: api.gateway.v1.GetStatusRequest
	(*GetStatusResponse)(nil), // 5: api.gateway.v1.GetStatusResponse
}
var file_gateway_proto_depIdxs = []int32{
	0, // 0: api.gateway.v1.GatewayService.Ping:input_type -> api.gateway.v1.PingRequest
	2, // 1: api.gateway.v1.GatewayService.Process:input_type -> api.gateway.v1.ProcessRequest
	4, // 2: api.gateway.v1.GatewayService.GetStatus:input_type -> api.gateway.v1.GetStatusRequest
	1, // 3: api.gateway.v1.GatewayService.Ping:output_type -> api.gateway.v1.PingResponse
	3, // 4: api.gateway.v1.GatewayService.Process:output_type -> api.gateway.v1.ProcessResponse
	5, // 5: api.gateway.v1.GatewayService.GetStatus:output_type -> api.gateway.v1.GetStatusResponse
...
func (c *gatewayServiceClient) Ping(ctx context.Context, in *PingRequest, opts ...grpc.CallOption) (*PingResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/api.gateway.v1.GatewayService/Ping", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *gatewayServiceClient) Process(ctx context.Context, in *ProcessRequest, opts ...grpc.CallOption) (*ProcessResponse, error) {
	out := new(ProcessResponse)
	err := c.cc.Invoke(ctx, "/api.gateway.v1.GatewayService/Process", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *gatewayServiceClient) GetStatus(ctx context.Context, in *GetStatusRequest, opts ...grpc.CallOption) (*GetStatusResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/api.gateway.v1.GatewayService/GetStatus", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (*UnimplementedGatewayServiceServer) Process(context.Context, *ProcessRequest) (*ProcessResponse, error) {
...
func _GatewayService_Ping_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/api.gateway.v1.GatewayService/Ping",
	}
...
func _GatewayService_Process_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/api.gateway.v1.GatewayService/Process",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(GatewayServiceServer).Process(ctx, req.(*ProcessRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _GatewayService_GetStatus_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/api.gateway.v1.GatewayService/GetStatus",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var _GatewayService_serviceDesc = grpc.ServiceDesc{
	ServiceName: "api.gateway.v1.GatewayService",
